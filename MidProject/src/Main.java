...
public class Main {
	...
	private static void deleteDataKaryawan(){
		...
		int indexToEdit = orderToEdit - 1;
		int indexToEditOriginalList = -1;
		...
		// Remove from vectors and update amount of employees
